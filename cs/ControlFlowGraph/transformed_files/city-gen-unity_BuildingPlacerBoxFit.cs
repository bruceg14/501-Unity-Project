...
public class TmpClass
{
    ...
    public void tmpFunction()
    {
        ...
        Console.WriteLine("Placing buildings...");
        ...
        while (false)
        {
            ...
            if (true)
            {
                ...
                Console.WriteLine($"Placed variant");
            }
            else
            {
                ...
                if (true)
                {
                    ...
                    // occupiedArea = 0;
                    // DestroyPlaced();
                    Console.WriteLine($"Resetting placement");
                    if (true)
                    {
                        Console.WriteLine($"Resetting placement");
                        // resetCounter = 0;
    ...
    private void PickAcceptableRotations()
    {
        ...
        Console.WriteLine("Picking acceptable rotations...");
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            Console.WriteLine($"Picked rotation {i}");
        }
    }
